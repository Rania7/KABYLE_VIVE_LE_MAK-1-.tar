...
def get_config(args=None, adjust_p_net_setting={}, adjust_v_sim_setting={}):
    ...
    print("config----------",config,"\n\n")
    print(config.nn_setting_path,"\n\n")
    print(config.rl_setting_path,"\n\n")
    print(config.run_setting_path,"\n\n")
    ...
    print("______________setting________")
    print(neural_network_settings.items(),"\n\n")
    print(rl_settings.items(),"\n\n")
    print(run_settings.items(),"\n\n")

...
class VNERLEnv(gym.Env):
    ...
    def __init__(self, allow_rejection=False, allow_revocable=False, **kwargs):
        ...
        #print("I am in VNERLEnv(gym.Env): printing Observation",self.obs_handler)
        
        self.degree_benchmark = self.p_net.degree_benchmark
        #print("I am in VNERLEnv(gym.Env): printing degree_benchmark",self.degree_benchmark)
        self.node_attr_benchmarks = self.p_net.node_attr_benchmarks
        self.link_attr_benchmarks = self.p_net.link_attr_benchmarks
        
        #print("I am in VNERLEnv(gym.Env): printing self.node_attr_benchmarks",self.node_attr_benchmarks)
        #print("I am in VNERLEnv(gym.Env): printing self.link_attr_benchmarks",self.link_attr_benchmarks)

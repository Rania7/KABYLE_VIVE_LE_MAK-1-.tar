...
class SubEnv(PlaceStepSubRLEnv):
    ...
    def __init__(self, p_net, v_net, controller, recorder, counter, **kwargs):
        ...
        print("i am in subEnv : num_p_net.get_node_attrs(['resource']",num_p_net_node_attrs)

        num_p_net_link_attrs = len(self.p_net.get_link_attrs(['resource']))
        print("i am in subEnv : num_p_net.get_link_attrs(['resource']",num_p_net_node_attrs)

        num_obs_attrs = num_p_net_node_attrs + num_p_net_link_attrs + 2
        print("num_obs_attrs",num_obs_attrs)
        ...
        print("graph metric ", self.calcuate_graph_metrics() )
    ...
    def get_observation(self):
        ...
        print("___________get_p_net_obs______",p_net_obs)

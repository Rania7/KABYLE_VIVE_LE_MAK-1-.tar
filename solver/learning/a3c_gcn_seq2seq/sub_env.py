...
class SubEnv(JointPRStepSubRLEnv):
    ...
    def __init__(self, p_net, v_net, controller, recorder, counter, **kwargs):
        print(" i am in SubEnv init => p_net, v_net, controller, recorder, counter, **kwargs",p_net, v_net, controller, recorder, counter, kwargs ,"\n\n ")
        ...
        print(" i am in SubEnv init=> num_p_net_node_attrs,num_p_net_link_attrs,num_p_net_features ",num_p_net_node_attrs,num_p_net_link_attrs,num_p_net_features ,"\n\n ")
    ...
    def compute_reward(self, solution):
        ...
        print("i am in SubEnv  reward ",reward,"\n\n ")  
        self.solution['v_net_reward'] += reward
        
        print("i am in SubEnv  reward cumulé ",self.solution['v_net_reward'] ,"\n\n ")
    ...
    def get_observation(self):
        ...
        print("i am in SubEnv  observation ",{'p_net_x': p_net_obs['x'],
                'p_net_edge_index': p_net_obs['edge_index'],
                'v_net_x': v_net_obs['x']} ,"\n\n ")

        return {'p_net_x': p_net_obs['x'], ## node data
                'p_net_edge_index': p_net_obs['edge_index'],
                'v_net_x': v_net_obs['x']} ## node data

    def _get_p_net_obs(self):  # en bleu ?
        """
        ...
        print("expand_dims(selected_nodes,)",np.expand_dims(selected_nodes, axis=-1),"\n\n ")
    ...
    def _get_v_net_obs(self): # en bleu?
